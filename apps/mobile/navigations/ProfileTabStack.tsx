...
// - Provides: Routes for Profile, Bookmarks, Post detail, Settings, ChatList, Notifications, About.
...
function ProfileTabStackHeader({ navigation }: Readonly<StackHeaderProps>) {
  return <TopBarNavigator navigation={navigation as any} />;
}
