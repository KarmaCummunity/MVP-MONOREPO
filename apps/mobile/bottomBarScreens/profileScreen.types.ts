/**
 * Shared types for ProfileScreen and its tab routes (Open/Closed).
 */
...
export interface ApiPost {
  ...
  created_at?: string;
  images?: unknown[];
  ride_data?: { id?: string; status?: string; from_location?: { city?: string; name?: string; address?: string }; to_location?: { city?: string; name?: string; address?: string }; available_seats?: number; price_per_seat?: number; departure_time?: string };
...
export type ProfileFeedItem = FeedItem & { rawData?: unknown; itemData?: unknown; rideData?: unknown };
