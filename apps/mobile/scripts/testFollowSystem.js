...
console.info(`User 1: ${user1.name} (${user1.id})`);
console.info(`User 2: ${user2.name} (${user2.id})`);

const followResult = followUser(user1.id, user2.id);
console.info(`Follow result: ${followResult ? 'SUCCESS' : 'FAILED'}`);
...
console.info(`\n📊 Follow Statistics:`);
console.info(`${user1.name}: ${stats1.followersCount} followers, ${stats1.followingCount} following`);
console.info(`${user2.name}: ${stats2.followersCount} followers, ${stats2.followingCount} following`);
console.info(`${user1.name} is following ${user2.name}: ${stats2.isFollowing}`);
...
console.info(`\n👥 Follow Lists:`);
console.info(`${user2.name} followers: ${user2Followers.map(u => u.name).join(', ')}`);
...
console.info(`Unfollow result: ${unfollowResult ? 'SUCCESS' : 'FAILED'}`);
...
console.info(`${user1.name} final following count: ${finalStats.followingCount}`);
...
console.info(`100 operations took: ${endTime - startTime}ms`);
...
console.info(`- System is working correctly with unified data`); 