...
* **מצב פרטיות פרופיל (פומבי / פרטי) + בקשות עקיבה** – פתרון לסתירה שזוהתה בבדיקת PRD: לא ייתכן ש"פוסט לעוקבים בלבד" יישא משמעות אם כל אחד יכול להפוך לעוקב מיידית בפרופיל פומבי. הוחלט לאמץ מודל היברידי בנוסח Instagram – פרופיל פומבי כברירת מחדל (זרימת PMF נשארת מהירה) + פרופיל פרטי כאופציה אמיתית. ראה [`03_Core_Features.md#3.2.3`](./03_Core_Features.md), [`07_Business_Rules.md`](./07_Business_Rules.md) (R-MVP-Profile-9..10, R-MVP-Privacy-11..13).
